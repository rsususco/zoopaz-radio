...
class Config {
    ...
    public function __construct () {
        ...
        $this->defaultMp3Dir = "{$this->webroot}/resources/music";

        // This is the root URL to the root location of your music archive. {@see $this->defaultMp3Dir}
        // No trailing slash.
        $this->defaultMp3Url = "{$this->host}/resources/music";
        ...
        // Absolute path - no trailing slash.
        $this->streamsDir = "{$this->webroot}/resources/m3u";
