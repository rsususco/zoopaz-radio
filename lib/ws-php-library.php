 ...
 * encrypt_md5(), decrypt_md5(), dir_filesize(), rmdir_r(), validate_xml()
 * validate_xml_return_errors(), writeUTF8File(). I believe they were all
 * found on http://docs.php.net, and some of the have been modified by myself.
 *
 * Current Functions
 * -----------------
