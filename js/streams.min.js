...
function removeRadioStation(a,b){var c=a||window.event,e=$(b).data("station");displayWorking();$.getJSON("ajax.php?action=removeRadioStation&station="+encodeURIComponent(e),function(a){"ok"===a.status?$(b).parent().remove():"error"===a.status?alert(a.message):alert("An unexpected error has occurred. Could not save radio.");handleLogoutJson(a);hideWorking()});c.stopPropagation();c.stopImmediatePropagation();c.cancelBubble=!0;return!1}
