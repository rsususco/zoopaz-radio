...
!0;return!1}function removeFromPersonalRadio(a,c){var b=a||window.event;displayWorking();var d=$(c).data("dir");$.getJSON("ajax.php?action=removeFromPersonalRadio&dir="+encodeURIComponent(d),function(a){handleLogoutJson(a);a=window.location.hash;a=a.replace(/^#/,"");switch(a.split("/")[1]){case "myradio":$(c).parent().parent().parent().parent().remove()}hideWorking()});b.stopPropagation();b.stopImmediatePropagation();b.cancelBubble=!0;return!1}
function addToPersonalRadio(a,c){var b=a||window.event;displayWorking();var d=$(c).data("dir");$.getJSON("ajax.php?action=addToPersonalRadio&dir="+encodeURIComponent(d),function(a){handleLogoutJson(a);hideWorking()});b.stopPropagation();b.stopImmediatePropagation();b.cancelBubble=!0;return!1}pt=null;
...
$(document).on("click",".createradiobutton",function(a){createPersonalRadio(a,this)});$(document).on("click",".addtoradiobutton",function(a){addToPersonalRadio(a,this)});$(document).on("click",".removefromradiobutton",function(a){removeFromPersonalRadio(a,this)});prevtime=parseInt((new Date).getTime());curval="";t=null;$(document).on("keyup","#search",function(){var a=new StreamsConfig;curval=$(this).val();curtime=parseInt((new Date).getTime());next=prevtime+a.searchThreshold;prevtime=curtime;curtime<
next&&(clearTimeout(t),t=setTimeout("search('"+curval+"')",a.searchThreshold))});$(".playlist-albumart").livequery(function(){var a=$(this);a.data("done")||$.getJSON("ajax.php?action=getAlbumArt&dir="+encodeURIComponent(a.data("dir"))+"&file="+encodeURIComponent(a.data("file")),function(c){a.attr("src",c.albumart);a.data("done",!0).css("width","2em").css("height","2em")})})});
