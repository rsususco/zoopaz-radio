...
function search(a){if(3>a.length)return getHomeIndex();0<$("#playbutton").length&&$("#playbutton").parent().remove();displayWorking();$.ajax({type:"GET",url:"ajax.php",data:"action=search&q="+encodeURIComponent(a),success:function(a){handleLogoutHtml(a);$("#musicindex").html(a);hideWorking()}})}function getHomeIndex(){displayWorking();$.ajax({type:"GET",url:"ajax.php",data:"action=getHomeIndex",success:function(a){handleLogoutHtml(a);$("#musicindex").html(a);hideWorking()}})}
function displayWorking(){$("#loading").css("display","block").css("visibility","visible")}function hideWorking(){$("#loading").css("display","none").css("visibility","hidden")}function clearPlaylist(){$.getJSON("ajax.php?action=clearPlaylist",function(){myPlaylist.remove()})}
