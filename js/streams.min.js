...
function playRadio(){isRadioMode=!0;displayWorking();var a=new StreamsConfig;$.ajax({type:"GET",url:"ajax.php",data:"action=playRadio&num="+a.numberOfRadioItems,success:function(a){var c=$("#content").width();$("#content-player").html(a);$(".album-title").text("Radio");$("#playbutton").remove();isMobile&&isMobile()&&($("#musicindex"),$("#playercontrols").remove(),a=c-16,$("#mediaplayer_wrapper").css("width",a+"px"),a=$("#mediaplayer").offset().top,window.scrollTo(0,a));$("#mediaplayer").bind($.jPlayer.event.play,
