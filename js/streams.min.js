...
"px"),a=$("#mediaplayer").offset().top,window.scrollTo(0,a));$("#mediaplayer").bind($.jPlayer.event.play,function(){console.log("bind: Playlist size: "+myPlaylist.playlist.length+", Current position: "+myPlaylist.current)}).bind($.jPlayer.event.ended,function(){myPlaylist.remove(myPlaylist.current-1);$.getJSON("ajax.php?action=getRandomPlaylist&num=1&personal=yes",function(a){$(a).each(function(a,b){myPlaylist.add(b)})})});hideWorking()});c.stopPropagation();c.stopImmediatePropagation();c.cancelBubble=
!0;return!1}
